export default function ResearchLabProjectPage() {
  return (
    <main className="min-h-screen bg-neutral-950 text-white">
      <div className="max-w-5xl mx-auto px-8 pt-12 pb-20">
        ...
        <p className="text-lg text-neutral-300 leading-relaxed max-w-3xl mb-16">
          Research Workspace is an AI-assisted quantitative research platform designed to evaluate alpha signals
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 text-neutral-400 max-w-3xl">
            <p>
              Research Workspace provides a structured environment for evaluating predictive signals across
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 text-neutral-400 max-w-3xl">
            <p>
              ...
              Research Workspace aims to standardize this process into a repeatable framework.
            </p>
            <p>
        ...
        <div className="inline-flex items-center px-4 py-2 rounded-md border border-neutral-700 text-sm text-neutral-300">
