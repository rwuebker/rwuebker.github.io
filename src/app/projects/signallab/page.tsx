    ...
    <main className="min-h-screen bg-neutral-950 text-white">
      <div className="max-w-5xl mx-auto px-8 pt-12 pb-20">
        ...
        <p className="text-lg text-neutral-300 leading-relaxed max-w-3xl mb-16">
          SignalLab is an AI-assisted quantitative research platform designed to evaluate alpha signals
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 text-neutral-400 max-w-3xl">
            <p>
              SignalLab provides a structured environment for evaluating predictive signals across
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 text-neutral-400 max-w-3xl">
            <p>
              ...
              SignalLab aims to standardize this process into a repeatable framework.
            </p>
            <p>
